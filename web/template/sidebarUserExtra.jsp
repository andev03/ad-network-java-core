        ...
        <div class="col-3 fullItem" style="
            ...
            <nav id="navbar-example3" class="h-100 flex-column align-items-stretch border-end">
                <nav class="nav nav-pills flex-column">
                    ...
                    <a class="nav-link hover" href="/AD_Network/#about">About</a>
                    <a class="nav-link hover" href="/AD_Network/#service">Service</a>
                    <nav class="nav nav-pills flex-column">
                    ...
                    <a class="nav-link hover" href="/AD_Network/#details">Details</a>
                </nav>
            </nav>
        </div>
    </body>
