<%-- 
    Document   : cameraService
    Created on : Feb 25, 2024, 7:02:12 PM
    Author     : user
--%>
    ...
    <body style="margin: 0">
        ...
        <main class="container-fluid row" style="padding: 0; margin: 0">
            ...
            <div class="col-9" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" tabindex="0"
                 style="padding: 0;">
                <img src="/AD_Network/assets/img/banner_service/bs_camera.png" style="width: 100%">
                <div class="cartModel">
                    ...
                    <div id="service" class="container" style="padding: 70px 0 55px 0px;">
                        <div class="row justify-content-around" style="margin: 0">
                            <c:forEach var="camera" items="${serviceInfor.getServiceByType(3)}">
                                <div id="camera" class="col-lg-5 service" style="margin-bottom: 3em;">
                                    <img src="/AD_Network/assets/img/banner_device/bd_camera.png" alt="" style="width: 100%;">
                                    <h2 class="fw-normal" style="color:#ff0000">${camera.serviceName}</h2>
                                    <h5 style="color: green">${camera.deviceId.deviceName}</h5>
                                    <p>${camera.deviceId.deviceDetailDesc}</p>
                                    <div style="color: #0000ff">
                                        <c:set var="pr" value="${camera.price}" />
                                        <fmt:formatNumber var="price" value="${pr}" type="number" pattern="###,###"/>
                                        <h4>${price}đ/tháng</h4>
                                    </div>
                                    <c:choose>
                                        <c:when test="${camera.serviceStatus.serviceStatus == 0}">
