<%-- 
    Document   : televisionService
    Created on : Feb 25, 2024, 7:01:58 PM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>Television Service</title>
    </head>
    <body style="margin: 0">
        ...
        <main class="container-fluid row" style="padding: 0; margin: 0">
            ...
            <div class="col-9" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" tabindex="0"
                 style="padding: 0;">
                <img src="/AD_Network/assets/img/banner_service/bs_television.png" style="width: 100%">
                <div class="cartModel">
                    ...
                    <div id="service" class="container" style="padding: 70px 0 55px 0px;">
                        <div class="row justify-content-around" style="margin: 0">
                            <c:forEach var="television" items="${serviceInfor.getServiceByType(4)}">
                                <div id="television" class="col-lg-5 service" style="margin-bottom: 3em;">
                                    <img src="/AD_Network/assets/img/banner_device/bd_television.png" alt="" style="width: 100%;">
                                    <h2 class="fw-normal" style="color:#ff0000">${television.serviceName}</h2>
                                    <h5 style="color: green">${television.deviceId.deviceName}</h5>
                                    <p>Tốc độ: ${television.deviceId.deviceDetailDesc}</p>
                                    <div style="color: #0000ff">
                                        <c:set var="pr" value="${television.price}" />
                                        <fmt:formatNumber var="price" value="${pr}" type="number" pattern="###,###"/>
                                        <h4>${price}đ/tháng</h4>
                                    </div>
                                    <c:choose>
                                        <c:when test="${television.serviceStatus.serviceStatus == 0}">
                                                        ...
                                                        <c:when test="${loca != null}">
                                                            <div style="width: 100%; display: flex; justify-content: flex-end;">
                                                                <form action="/AD_Network/MainController" method="post">
                                                                    ...
                                                                    <input type="hidden" name="service" value="${television.serviceId}">
                                                                ...
                                                                <form action="/AD_Network/MainController" method="get">
                                                                    ...
                                                                    <input type="hidden" name="pageAction" value="television">
                                                                    <input type="hidden" name="service" value="${television.serviceId}">
