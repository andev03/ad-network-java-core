<%-- 
    ...
    Created on : Mar 5, 2024, 3:54:09 PM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <c:set var="locationDetail" value="${location.getLocationByUserId(cus.userId.userId)}" scope="page"/>
            ...
            <div class="col-9" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" tabindex="0"
                ...
                <div class="container py-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" readonly class="form-control" id="fullName" value="${cus.userId.fullName}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <c:choose>
                            <c:when test="${cus.userId.phoneNumber==null}">
                                <div class="form-control" id="locaDe" style="color: red; font-weight: bold;">Empty</div>
                            </c:when>
                            <c:otherwise>
                                <input type="tel" readonly class="form-control" id="phoneNumContact" value="${cus.userId.phoneNumber}">
                            </c:otherwise>
                        </c:choose>
                    </div>
                    <div class="mb-3">
                        ...
                        <c:choose>
                            <c:when test="${cus.userId.email==null}">
                                <div class="form-control" id="locaDe" style="color: red; font-weight: bold;">Empty</div>
                            </c:when>
                            <c:otherwise>
                                <input type="email" readonly class="form-control" id="emailContact" value="${cus.userId.email}">
                            </c:otherwise>
                        </c:choose>
                    </div>
                    <div class="mb-3">
                        ...
                        <c:choose>
                            <c:when test="${cus.userId.identityNo==null}">
                                <div class="form-control" id="locaDe" style="color: red; font-weight: bold;">Empty</div>
                            </c:when>
                            <c:otherwise>
                                <input type="text" readonly class="form-control" id="IdentityNum" value="${cus.userId.identityNo}">
                            </c:otherwise>
                        </c:choose>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" readonly class="form-control" id="phoneNumberRe" value="${cus.accTel}">
                    </div>
                    <div class="mb-3">
                        <label for="pass" class="form-label fw-bold">Password</label>
                        <input type="password" readonly class="form-control" id="pass" value="${cus.accPassCus}">
                    </div>
                </div>
                <div class="d-flex justify-content-center" style="padding: 15px;">
                    <a href="/AD_Network/MainController?view=viewEditProfileCustomer" class="text-decoration-none btn btn-primary btn-success" style="width: 80%; ">Edit</a>
                </div>
            </div>
        </main>
