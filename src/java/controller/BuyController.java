    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("typeBuy").equalsIgnoreCase("buyNow")) {
                request.setAttribute("typeBuy", "buyNow");
                request.setAttribute("transCycleBuyNow", request.getParameter("transCycleBuyNow"));
                request.setAttribute("service", serDao.getService(Integer.parseInt(request.getParameter("service"))));
            } else {
            ...
            request.getRequestDispatcher("view/platform/payment.jsp").forward(request, response);
        }
    }
